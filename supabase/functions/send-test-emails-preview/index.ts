...
<body style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Arial, sans-serif; line-height: 1.6; color: #1f2937; margin: 0; padding: 0; background-color: #f3f4f6;">
  <div style="max-width: 700px; margin: 0 auto; padding: 20px;">
    <div style="background-color: #ffffff; border-radius: 12px; overflow: hidden; box-shadow: 0 4px 6px -1px rgba(0,0,0,0.1);">
      <div style="background:#000000;padding:20px;text-align:center;"><img src="https://aeight-flow.lovable.app/__l5e/assets-v1/8247fcee-a153-4eb0-a1fc-2aea05a49bfb/logo-grupo-aeight.png" alt="Grupo A&amp;EIGHT" style="max-width:320px;width:100%;height:auto;display:inline-block;border:0;" /></div>
...
const dadosB8one: DadosBancarios = {
  ...
  conta: "00425644-1",
  tipo_conta: "corrente",
  descricao: "Banco BTG Pactual - Matriz b8one",
  chave_pix: "f71e0e90-aac0-40c0-ad3a-f5190e17b536",
};
...
const dadosLomadee: DadosBancarios = {
  ...
  chave_pix: "25548d3a-02a2-484d-9acd-1b11ab453a65",
};
...
const dadosCryah: DadosBancarios = {
  ...
  chave_pix: "887b77bd-d159-410a-9050-a87cd8b67009",
};
