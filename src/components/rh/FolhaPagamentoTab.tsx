...
export function FolhaPagamentoTab() {
  ...
  const getFolhaStatusBadge = (status: string) => {
    switch (status) {
      case 'aprovado':
      case 'processado': return <Badge className="bg-green-100 text-green-800 hover:bg-green-100">Aprovado</Badge>;
      case 'pendente_aprovacao_rh': return <Badge className="bg-blue-100 text-blue-800 hover:bg-blue-100">Em aprovação</Badge>;
