...
const statusLabels: Record<string, { label: string; color: string; icon: any }> = {
  ...
  aprovado_lider: { label: 'Aprovado pelo Líder', color: 'bg-violet-100 text-violet-800 dark:bg-violet-900/30 dark:text-violet-300', icon: CheckCircle2 },
  ...
  pendente_rh: { label: 'Pendente RH', color: 'bg-amber-100 text-amber-800 dark:bg-amber-900/30 dark:text-amber-300', icon: Clock },
  rejeitado_rh: { label: 'Rejeitado pelo RH', color: 'bg-red-100 text-red-800 dark:bg-red-900/30 dark:text-red-300', icon: XCircle },
  aprovado_rh: { label: 'Aprovado RH', color: 'bg-blue-100 text-blue-800 dark:bg-blue-900/30 dark:text-blue-300', icon: CheckCircle2 },
