...
export default defineConfig(({ mode }) => ({
  ...
  plugins: [
    ...
    VitePWA({
      ...
      includeAssets: [
        "favicon-ampersand-black.png",
        "favicon-ampersand-black.ico",
        "icons/icon-ampersand-black-192.png",
        "icons/icon-ampersand-black-512.png",
        "icons/apple-touch-icon-ampersand-black.png",
      ],
      workbox: {
      ...
      manifest: {
        ...
        icons: [
          {
            src: "/icons/icon-ampersand-black-192.png",
            sizes: "192x192",
            type: "image/png",
            purpose: "any",
          },
          {
            src: "/icons/icon-ampersand-black-512.png",
            sizes: "512x512",
            type: "image/png",
            purpose: "any",
          },
          {
            src: "/icons/icon-ampersand-black-maskable-512.png",
            sizes: "512x512",
            type: "image/png",
            purpose: "maskable",
          },
